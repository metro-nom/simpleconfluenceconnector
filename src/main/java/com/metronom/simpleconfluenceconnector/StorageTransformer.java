...
public class StorageTransformer {
    ...
    throws TransformerException, UnsupportedEncodingException {
        ...
        final Transformer tr = StorageTransformer.TRANSFORMER_FACTORY.newTransformer();
    ...
    public static Document parseDocumentFromStorage(final String storage)
    throws ParserConfigurationException, UnsupportedEncodingException, SAXException, IOException {
        final DocumentBuilder builder = StorageTransformer.DOCUMENT_BUILDER_FACTORY.newDocumentBuilder();
        final StringBuilder toParse = new StringBuilder();
        StorageTransformer.appendHTMLEntities(toParse);
        toParse.append(storage);
        return builder.parse(new ByteArrayInputStream(toParse.toString().getBytes("UTF-8")));
    }
